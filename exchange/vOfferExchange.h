// Fork of Stellar Development Foundation and contributors: stellar-core/src/transactions/OfferExchange.h
#pragma once
...
int8_t sea_nd_i8(void);
uint8_t sea_nd_u8(void);
int16_t sea_nd_i16(void);
uint16_t sea_nd_u16(void);
int32_t sea_nd_i32(void);
uint32_t sea_nd_u32(void);
int64_t sea_nd_i64(void);
uint64_t sea_nd_u64(void);
